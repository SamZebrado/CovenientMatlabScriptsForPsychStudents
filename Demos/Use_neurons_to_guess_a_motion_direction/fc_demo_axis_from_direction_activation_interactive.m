...
f = figure('Name','Axis Estimation Demo','Position',[200 200 1000 600]);
...
% UI 放到 Stimulus 图下方
add_slider('Stimulus Axis (deg)', 0, 180, rad2deg(param.axis_angle), [80, 180], 'axis');
add_slider('Num of Neurons', 6, 48, param.n_neurons, [80, 140], 'neurons');
add_slider('Axis Selectivity', 0.5, 5, param.selectivity, [80, 100], 'selectivity');
add_slider('Noise Level', 0, 0.5, param.noise_level, [80, 60], 'noise');
